...
function loaded() {
	...
	var isImport = user.hasRole("import");
	var isExport = user.hasRole("export");
	var hasImport = ctpServer.hasStage("org.rsna.isn.ctp.xds.receiver.PollingXDSImportService")
						|| ctpServer.hasStage("org.rsna.isn.ctp.xds.receiver.XDSImportService");
	var hasExport = ctpServer.hasStage("org.rsna.isn.ctp.xds.sender.CachingXDSExportService");

	setVisibility("Admin", isAdmin);
	setVisibility("Import", isImport && hasImport);
